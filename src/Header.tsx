        ...
        <div className="sm:hidden">
          <div className="flex items-center justify-between py-3">
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md active:scale-95 transition-transform"
              dir="rtl"
            >
              <PhoneIcon className="h-4 w-4" />
              <span className="text-sm font-semibold">חייגו</span>
            </a>
            ...
            <DisclosureButton className="flex items-center justify-center rounded-xl p-2 text-neutral-700 hover:bg-neutral-100 active:scale-95 transition-all">
          ...
          <div className="flex items-center justify-between py-4 gap-8">
            ...
            <div className="flex gap-2">
              <a
                href="tel:0504020170"
                aria-label="חייגו עכשיו: 050-402-0170"
                className="flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg group"
                dir="rtl"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700 transition-all duration-200 shadow-md hover:shadow-lg group"
                dir="rtl"
              >
              ...
              <a
                ...
                className="flex items-center justify-center p-2.5 rounded-xl bg-gradient-to-r from-pink-500 to-pink-600 text-white hover:from-pink-600 hover:to-pink-700 transition-all duration-200 shadow-md hover:shadow-lg group"
                dir="rtl"
              >
        ...
        <div className="px-4 py-3 space-y-3 bg-gradient-to-b from-neutral-50 to-white border-t border-neutral-200">
          ...
          <div className="pt-3 space-y-2 border-t border-neutral-200">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="פתיחת שיחת WhatsApp"
              className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white shadow-md active:scale-98 transition-transform"
              dir="rtl"
            >
              <WhatsAppIcon className="h-5 w-5" />
              <span className="text-sm font-semibold">שלחו הודעה ב-WhatsApp</span>
            </a>
            <a
              href="https://www.instagram.com/poppipe.plumbing?igsh=MTR5b3ExamVodzVoaQ=="
              target="_blank"
              rel="noopener noreferrer"
              aria-label="עקבו באינסטגרם"
              className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-pink-500 to-pink-600 text-white shadow-md active:scale-98 transition-transform"
              dir="rtl"
            >
              <InstagramIcon className="h-5 w-5" />
              <span className="text-sm font-semibold">עקבו באינסטגרם</span>
            </a>
          </div>
        </div>
      </DisclosurePanel>
